...
namespace DSharpPlus.Net.WebSocket
{
    ...
    /// </summary>
    public class Win32WebSocketClient : BaseWebSocketClient
    {
        ...
        private System.Net.WebSockets.WebSocket Socket { get; set; }
        ...
        public Win32WebSocketClient(IWebProxy proxy)
            : base(proxy)
        {
        ...
        public override async Task ConnectAsync(Uri uri)
        {
            ...
            //Socket.KeepAliveInterval = TimeSpan.FromSeconds(20);
        ...
        public static BaseWebSocketClient CreateNew(IWebProxy proxy)
            => new Win32WebSocketClient(proxy);
