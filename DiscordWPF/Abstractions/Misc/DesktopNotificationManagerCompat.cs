...
namespace DiscordWPF.Specifics.UWP
{
    ...
    {
        public const string TOAST_ACTIVATED_LAUNCH_ARG = "--activation=toast";
        ...
        public static void RegisterAumidAndComServer<T>(string aumid) where T : NotificationActivator
        {
